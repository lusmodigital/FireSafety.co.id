---
article_id: FS-08-A01
title: "Perbedaan Hidran Halaman, Standpipe, dan Hose Reel"
slug: "hidran-halaman-standpipe-hose-reel"
description: "Explain intended users, locations, components, supply relationship, and operational limits"
status: outline
publication_date: "2025-07-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: FS-08
primary_intent: "Distinguish water-distribution systems"
reader_community: "Firesafety.co.id"
reader_address: "Kawan Firesafety.co.id"
final_route: "/artikel/hidran-halaman-standpipe-hose-reel.html"
...
# Perbedaan Hidran Halaman, Standpipe, dan Hose Reel

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Perbedaan Hidran Halaman, Standpipe, dan Hose Reel”
- **Reader and situation:** Owner reading a proposal
- **Reader outcome:** Explain intended users, locations, components, supply relationship, and operational limits
- **Primary intent:** Distinguish water-distribution systems
...
- **Scope boundary:** Excludes required quantities and hydraulic design
- **Final public route:** `/artikel/hidran-halaman-standpipe-hose-reel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Perbedaan Hidran Halaman, Standpipe, dan Hose Reel**.
...
- `FS-08-A02` → `/artikel/komponen-sistem-hidran.html` — Hydrant Box, Valve, Hose, Nozzle, dan Pillar: Fungsi Setiap Komponen
...
- **Tie back to this article:** Keep the explanation specific to “Perbedaan Hidran Halaman, Standpipe, dan Hose Reel”.
