---
article_id: FS-18-A03
title: "Inspeksi Helm, Baju, Sarung Tangan, Sepatu, dan SCBA"
slug: "inspeksi-apd-pemadam"
description: "Build pre-use and periodic checks for damage, contamination, compatibility, records, and quarantine"
status: outline
publication_date: "2026-03-11"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: FS-18
primary_intent: "Inspect firefighting PPE condition"
reader_community: "Firesafety.co.id"
reader_address: "Kawan Firesafety.co.id"
final_route: "/artikel/inspeksi-apd-pemadam.html"
...
# Inspeksi Helm, Baju, Sarung Tangan, Sepatu, dan SCBA

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Inspeksi Helm, Baju, Sarung Tangan, Sepatu, dan SCBA”
- **Reader and situation:** Emergency team equipment custodian
- **Reader outcome:** Build pre-use and periodic checks for damage, contamination, compatibility, records, and quarantine
- **Primary intent:** Inspect firefighting PPE condition
...
- **Scope boundary:** Excludes repair outside manufacturer authorization
- **Final public route:** `/artikel/inspeksi-apd-pemadam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Inspeksi Helm, Baju, Sarung Tangan, Sepatu, dan SCBA**.
...
- `FS-18-A05` → `/artikel/kapan-apd-pemadam-diganti.html` — Kapan APD Pemadam Harus Ditarik dari Layanan
...
- **Tie back to this article:** Keep the explanation specific to “Inspeksi Helm, Baju, Sarung Tangan, Sepatu, dan SCBA”.
