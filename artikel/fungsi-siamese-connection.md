---
article_id: FS-08-A03
title: "Siamese Connection atau Fire Department Connection: Fungsi dan Aksesnya"
slug: "fungsi-siamese-connection"
description: "Explain external supply connection, identification, obstruction, caps, valves, and coordination questions"
status: outline
publication_date: "2025-07-15"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: FS-08
primary_intent: "Understand fire-service inlet"
reader_community: "Firesafety.co.id"
reader_address: "Sobat Firesafety.co.id"
final_route: "/artikel/fungsi-siamese-connection.html"
...
# Siamese Connection atau Fire Department Connection: Fungsi dan Aksesnya

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Siamese Connection atau Fire Department Connection: Fungsi dan Aksesnya”
- **Reader and situation:** Building owner protecting access
- **Reader outcome:** Explain external supply connection, identification, obstruction, caps, valves, and coordination questions
- **Primary intent:** Understand fire-service inlet
...
- **Scope boundary:** Excludes fire-brigade tactical procedure
- **Final public route:** `/artikel/fungsi-siamese-connection.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Siamese Connection atau Fire Department Connection: Fungsi dan Aksesnya**.
...
- `FS-08-A01` → `/artikel/hidran-halaman-standpipe-hose-reel.html` — Perbedaan Hidran Halaman, Standpipe, dan Hose Reel
...
- `FS-08-A05` → `/artikel/zoning-tekanan-sistem-hidran.html` — Zoning dan Tekanan pada Sistem Hidran Gedung Bertingkat
...
- **Tie back to this article:** Keep the explanation specific to “Siamese Connection atau Fire Department Connection: Fungsi dan Aksesnya”.
